<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <style>
          <?php include 'css/ssb-admin-2.min.css'; ?>
      </style>
      <!-- Nav Item - Dashboard -->
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="Informasi.html">Matakuliah</a>
            <a class="collapse-item" href="404.html">Mahasiswa</a>
            <a class="collapse-item" href="blank.html">Tahun Akademik</a>
            <a class="collapse-item" href="blank.html">KRS</a>
            <a class="collapse-item" href="blank.html">Input Nilai</a>
            <a class="collapse-item" href="blank.html">KHS</a>
            <a class="collapse-item" href="blank.html">Cetak Transkip</a>
            <a class="collapse-item" href="blank.html">Dosen</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="Identitas.html">Identitas</a>
            <a class="collapse-item" href="Kategori.html">Kategori</a>
            <a class="collapse-item" href="Informasi.html">Informasi Kampus</a>
